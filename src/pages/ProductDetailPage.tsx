...
const ProductDetailPage = () => {
    ...
    return (
        <>
            <SEO
                title={`${product.name} - Premium ${product.category} | Yashwanth Colour Coatings`}
                description={product.description}
                keywords={`${product.name}, ${product.category}, industrial coating, automotive paint, Chennai`}
                    ...
                    <div className="product-detail-content">
                        ...
                        <div className="product-images">
                            <div className="product-image-main">
                                <img src={product.images[selectedImage]} alt={product.name} width="600" height="600" />
                            </div>
                            <div className="product-image-thumbnails">
                                {product.images.map((image, index) => (
                                    ...
                                    >
                                        <img src={image} alt={`${product.name} ${index + 1}`} loading="lazy" width="100" height="100" />
                                    </button>
                                ))}
                            </div>
                        </div>
